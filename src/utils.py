...
def replace_halogen(string):
    """Replace Br and Cl with R and L respectively."""
    br = re.compile("Br")
    cl = re.compile("Cl")
    br_replaced = br.sub("R", string)
    cl_br_replaced = cl.sub("L", br_replaced)
    return cl_br_replaced
